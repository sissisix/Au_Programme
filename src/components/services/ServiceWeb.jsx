        ...
        <div>
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div className="p-8 sm:p-10 lg:flex-auto">
                    <h3 className="text-2xl font-bold tracking-tight text-darkBlue">Site web simple</h3>
                    <p className="mt-6 text-base leading-7 text-gray-600">Site web basique tel qu'une vitrine pour votre shop.</p>
            ...
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div className="p-8 sm:p-10 lg:flex-auto">
                    <h3 className="text-2xl font-bold tracking-tight text-darkBlue">Site web standard</h3>
                    <p className="mt-6 text-base leading-7 text-gray-600">Site web standard avec intégration d'API.</p>
                    <div className="mt-10 flex items-center gap-x-4">
                        <h4 className="flex-none text-sm font-semibold leading-6 text-darkBlue">Inclut</h4>
                        <div className="h-px flex-auto bg-gray-100"></div>
                    </div>
            ...
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div className="p-8 sm:p-10 lg:flex-auto">
                    <h3 className="text-2xl font-bold tracking-tight text-darkBlue">Site web avancé</h3>
                    <p className="mt-6 text-base leading-7 text-gray-600">Site web personnalisée avec API et backends pour sites complexes et avancés.</p>
                    <div className="mt-10 flex items-center gap-x-4">
                        <h4 className="flex-none text-sm font-semibold leading-6 text-darkBlue">Inclut</h4>
                        <div className="h-px flex-auto bg-gray-100"></div>
                    </div>
